...
var doc = `{
    ...
    "tags": [
        {
            "description": "不需要登陆，但是会验证头信息 , X-SourceType X-Access X-Project 等",
            "name": "Base"
        },
        {
...
var SwaggerInfo = swaggerInfo{
	...
	Schemes:     []string{},
	Title:       "z golang 框架",
	Description: "restful api 工具，模拟客户端请求，方便调试/测试\n注：这只是一个工具，不是万能的，像：动态枚举类型、公共请求header、动态常量等,详细的请去 <a href=\"http://127.0.0.1:6060\" target=\"_black\">godoc</a> 里去查看\n注：所有 header 遵循HTTP标准，即：header中每个key 以大写X开头，单词以中划线分隔，每个单词首字母大写\n注：所有接口的响应格式均是json:code data msg ,具体参考 model.httpresponse.Response",
}
