...
type CicdPublish struct {
	...
	ServiceInfo string `json:"service_info" form:"service_info" db:"define:varchar(50);comment:服务信息-备份;defaultValue:''"`
	ServerInfo  string `json:"server_info" form:"server_info" db:"define:varchar(50);comment:服务器信息-备份;defaultValue:''"`
