...
type CicdPublish struct {
	...
	ServiceInfo  string `json:"service_info" form:"service_info" db:"define:text;comment:服务信息-备份"`
	ServerInfo   string `json:"server_info" form:"server_info" db:"define:text;comment:服务器信息-备份"`
	...
	Step         int    `json:"step" form:"step" db:"define:int;comment:执行到第几步了;defaultValue:0"`
	Log          string `json:"log" form:"log" db:"define:text;comment:日志"`
