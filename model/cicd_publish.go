...
type CICDPublish struct {
	...
	HostId		int 		`json:"host_id" form:"host_id" db:"define:int;comment:服务器ID;defaultValue:0"`
	Status 		int 		`json:"status" form:"status" db:"define:tinyint(1);comment:0发布中2发布失败3发布成功;defaultValue:0"`
