...
type SmsLog struct {
	MODEL
	ProjectId           int    `json:"app_id" db:"define:int;comment:项目ID;defaultValue:0"`
	...
	RuleId              int    `json:"rule_id" db:"define:tinyint(1);comment:规则ID;defaultValue:0"`
	Uid                 int    `json:"uid" db:"define:INT;comment:用户ID;defaultValue:0"`
	Type                int    `json:"type" db:"define:tinyint(1);comment:类型，0验证码1通知2营销3国际;defaultValue:0"`
