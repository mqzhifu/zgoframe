...
func (*UnimplementedFrameSyncServer) CS_Heartbeat(ctx context.Context, req *Heartbeat) (*Empty, error) {
...
func (*UnimplementedFrameSyncServer) SC_Heartbeat(ctx context.Context, req *Heartbeat) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SC_Heartbeat not implemented")
}
func (*UnimplementedFrameSyncServer) FdClose(ctx context.Context, req *FDCloseEvent) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FdClose not implemented")
}
func (*UnimplementedFrameSyncServer) FdCreate(ctx context.Context, req *FDCreateEvent) (*Empty, error) {
