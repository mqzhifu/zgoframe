...
func (*GameMatchSign) Descriptor() ([]byte, []int) {
	return fileDescriptor_game_match_6be4055654954113, []int{0}
}
...
func (dst *GameMatchSign) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GameMatchSign.Merge(dst, src)
}
...
func (*GameMatchSignPlayer) Descriptor() ([]byte, []int) {
	return fileDescriptor_game_match_6be4055654954113, []int{1}
}
...
func (dst *GameMatchSignPlayer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GameMatchSignPlayer.Merge(dst, src)
}
...
func (*GameMatchPlayerCancel) Descriptor() ([]byte, []int) {
	return fileDescriptor_game_match_6be4055654954113, []int{2}
}
...
func (dst *GameMatchPlayerCancel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GameMatchPlayerCancel.Merge(dst, src)
}
...
func (*GameMatchOptResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_game_match_6be4055654954113, []int{3}
}
...
func (dst *GameMatchOptResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GameMatchOptResult.Merge(dst, src)
}
...
func init() { proto.RegisterFile("game_match.proto", fileDescriptor_game_match_6be4055654954113) }

var fileDescriptor_game_match_6be4055654954113 = []byte{
