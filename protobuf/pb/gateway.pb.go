...
func (*UnimplementedGatewayServer) SC_ProjectPushMsg(ctx context.Context, req *ProjectPushMsg) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SC_ProjectPushMsg not implemented")
}
func (*UnimplementedGatewayServer) SC_SendMsg(ctx context.Context, req *Msg) (*Empty, error) {
