...
func (*Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{0}
}
...
func (*Login) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{1}
}
...
func (*LoginRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{2}
}
...
func (*ProjectPushMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{3}
}
...
func (*KickOff) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{4}
}
...
func (*CfgServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{5}
}
...
func (*CfgProtoMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{6}
}
...
func (*CfgProtoServiceFunc) Descriptor() ([]byte, []int) {
	return fileDescriptor_gateway_79a2e8ffeb99cef2, []int{7}
}
...
func init() { proto.RegisterFile("gateway.proto", fileDescriptor_gateway_79a2e8ffeb99cef2) }

var fileDescriptor_gateway_79a2e8ffeb99cef2 = []byte{
	...
	,
}
