...
//	gamematch.HttpdRuleState[ruleId] = service.HTTPD_RULE_STATE_CLOSE
...
//		gamematch.signSend(mychann, service.SIGNAL_GOROUTINE_EXEC_EXIT, title)
//	}
//
//	closeRoutineCnt := 0
//	for {
...
//	//}
//	gamematch.signSend(httpdChan, service.SIGNAL_GOROUTINE_EXEC_EXIT, "httpd")
...
//			mylog.Warn("SIGNAL send: " + strconv.Itoa(service.SIGNAL_GOROUTINE_EXIT_FINISH) + getSignalDesc(service.SIGNAL_GOROUTINE_EXIT_FINISH) + title)
//			signalChan <- service.SIGNAL_GOROUTINE_EXIT_FINISH
//			goto forEnd
//		default:
//			handler()
