...
//	return service.RedisPrefix + service.RedisSeparation + "rule"
//}
//
//func (ruleConfig *RuleConfig) getRedisIncKey() string {
//	return service.RedisPrefix + service.RedisSeparation + "rule" + service.RedisSeparation + "inc"
//}
//
////初始化
...
//	watchChann := myetcd.Watch(ctx, service.RuleEtcdConfigPrefix)
...
//			matchCode := strings.Replace(key, service.RuleEtcdConfigPrefix, "", -1)
//			//过滤掉空格
...
//	}
//
//	if gamesMatchConfig.Status != service.RuleStatusOnline {
...
//	return rule, err
//}
//func (ruleConfig *RuleConfig) GetData(dataSourceType int) {
//	switch dataSourceType {
//	case service.GAME_MATCH_DATA_SOURCE_TYPE_ETCD:
//	case service.GAME_MATCH_DATA_SOURCE_TYPE_DB:
//	default:
//		util.ExitPrint("dataSourceType err")
//
//	}
//}
//
//func (ruleConfig *RuleConfig) GetDataByDb() (list map[int]Rule, err error) {
//	var listGameMatchRule model.GameMatchRule
//	err = ruleConfig.Gorm.Where("status = 1").Find(list).Error
//	if err != nil {
//		return list, err
//	}
//
...
//	}
//
//	for k, v := range listGameMatchRule {
//
//	}
//}
//
//func (ruleConfig *RuleConfig) GetDataByEtcd() (map[int]Rule, error) {
//	etcdRuleList, err := myetcd.GetListByPrefix(service.RuleEtcdConfigPrefix)
//	if err != nil {
...
//
//	str := strconv.Itoa(rule.Id) + service.Separation +
//		strconv.Itoa(rule.AppId) + service.Separation +
//		rule.CategoryKey + service.Separation +
//		strconv.Itoa(rule.MatchTimeout) + service.Separation +
//		strconv.Itoa(rule.SuccessTimeout) + service.Separation +
//		strconv.Itoa(rule.PersonCondition) + service.Separation +
//		//strconv.Itoa(rule.IsSupportGroup) + separation +
//		strconv.Itoa(rule.Flag) + service.Separation +
//		strconv.Itoa(rule.TeamVSPerson) + service.Separation +
...
//		}
//
//		if rule.TeamVSPerson > service.RuleTeamVSPersonMax {
//			return false, myerr.NewReplace(609, myerr.MakeOneStringReplace(strconv.Itoa(service.RuleTeamVSPersonMax)))
//		}
//		//TeamVSPerson	int		//如果是N VS N 的类型，得确定 每个队伍几个人,必须上面的flag = 1 ，该变量才有用,目前最大是5
//	} else if rule.Flag == service.RuleFlagCollectPerson {
//		if rule.PersonCondition <= 0 {
//			return false, myerr.New(610)
//		}
//
//		if rule.PersonCondition > service.RulePersonConditionMax {
//			return false, myerr.NewReplace(611, myerr.MakeOneStringReplace(strconv.Itoa(service.RuleTeamVSPersonMax)))
//		}
//	} else {
//		return false, myerr.New(607)
//	}
//	if rule.MatchTimeout < service.RuleMatchTimeoutMin || rule.MatchTimeout > service.RuleMatchTimeoutMax {
//		msg := make(map[int]string)
//		msg[0] = strconv.Itoa(service.RuleMatchTimeoutMin)
//		msg[1] = strconv.Itoa(service.RuleMatchTimeoutMax)
//		return false, myerr.NewReplace(612, msg)
//	}
//
//	if rule.SuccessTimeout < service.RuleSuccessTimeoutMin || rule.SuccessTimeout > service.RuleSuccessTimeoutMax {
//		msg := make(map[int]string)
//		msg[0] = strconv.Itoa(service.RuleSuccessTimeoutMin)
//		msg[1] = strconv.Itoa(service.RuleSuccessTimeoutMax)
...
//	}
//
//	if rule.GroupPersonMax > service.RuleGroupPersonMax {
//		return false, myerr.NewReplace(615, myerr.MakeOneStringReplace(strconv.Itoa(service.RuleGroupPersonMax)))
//	}
//
