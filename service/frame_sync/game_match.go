...
//	RequestServiceAdapter *RequestServiceAdapter //请求3方服务 适配器
//}
//
...
//}
//
//func (match *Match) AddOnePlayer(requestPlayerMatchSign pb.GameMatchSign) {
//	//playerId := conn.UserId
//	//player, empty := myPlayerManager.GetById(requestPlayerMatchSign.PlayerId)
//	if requestPlayerMatchSign.SourceUid <= 0 {
//		msg := "conn.UserId <= 0"
//		match.matchSignErrAndSend(msg)
//		return
//	}
//
...
//	match.Option.RequestServiceAdapter.PushMsg()
//}
//
